...
#include "../include/rovtio/ImagePyramid.hpp"
#include "../include/rovtio/FeatureManager.hpp"
#include "../include/rovtio/MultilevelPatchAlignment.hpp"

using namespace rovtio;
